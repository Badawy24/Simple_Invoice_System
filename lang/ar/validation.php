...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي :attribute فقط على رموز أبجدية أو أرقام أحادية البايت.',
    ...
    'between' => [
        ...
        'string' => ':attribute يجب أن يكون بين :min و :max أحرف/حروف.',
    ],
    ...
    'digits_between' => 'يجب أن يحتوي حقل :attribute على عدد من الأرقام يتراوح بين :min و :max.',
    'dimensions' => 'الصورة المحددة في حقل :attribute غير صالحة الأبعاد.',
    ...
    'missing_with' => 'يجب أن يكون حقل :attribute مفقودًا عندما يتم توفير :values.',
    'missing_with_all' => 'يجب أن يكون حقل :attribute مفقودًا عندما يتم توفير :values.',
    'multiple_of' => 'يجب أن يكون :attribute مضاعفًا لـ :value.',
    'not_in' => 'تم اختيار :attribute الذي تم تحديده غير صالح.',
    ...
    'prohibited_unless' => 'حقل :attribute ممنوع ما لم يكن :other موجود في :values.',
    ...
    'required_unless' => 'حقل :attribute مطلوب ما لم يكن :other موجود في :values.',
    'required_with' => 'حقل :attribute مطلوب عندما يتم توفر :values.',
    'required_with_all' => 'حقل :attribute مطلوب عندما يتم توفر جميع :values.',
    'required_without' => 'حقل :attribute مطلوب عندما لا يتم توفر :values.',
    ...
    'uppercase' => 'يجب أن يكون :attribute حروف كبيرة.',
