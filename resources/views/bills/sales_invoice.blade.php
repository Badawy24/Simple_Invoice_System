...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الفواتير </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/فواتير المبيعات </span>
        </div>
    </div>
                    ...
                    <table class="table text-md-nowrap" id="example">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">خصم الفاتورة</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$bill->discount_bill}} %</td>
                                <td>{{$bill->TotalAmount}} جنيه</td>
                                <td><?php echo $formattedDate; ?></td>
                                <td>مبيعات</td>
                                <td class="text-center">
                                    <form method="get" action="/view_sales_invoice/{{$bill->BillID}}">
