...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">فاتورة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ المشتريات</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        ...
        <div id="printable-content" class="card-body">
            <div class="table-responsive">
                <form method="POST" action="/confirm_edit_purchase_invoice/{{$bill_details[0]->BillID}}">
                    @csrf
        ...
        <script>
            ...
            function calculateTotal() {
                ...
                totalInput.value = total.toFixed(2); // Set the total to the input field
            }
